	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.GET("/models/availability", controller.GetModelAvailability)
				...
				selfRoute.POST("/ethereum/pay", middleware.CriticalRateLimit(), controller.RequestEthereumPay)
		...
		subscriptionRoute.Use(middleware.UserAuth())
		{
			...
			subscriptionRoute.GET("/orders/self", controller.GetSubscriptionOrdersSelf)
			subscriptionRoute.PUT("/self/preference", controller.UpdateSubscriptionPreference)
			subscriptionRoute.POST("/self/switch", middleware.CriticalRateLimit(), controller.SwitchSelfSubscription)
			subscriptionRoute.POST("/orders/:tradeNo/cancel", middleware.CriticalRateLimit(), controller.CancelSubscriptionOrderSelf)
		...
		apiRouter.POST("/user/epay/notify", controller.EpayUnifiedNotify)
		apiRouter.GET("/user/epay/notify", controller.EpayUnifiedNotify)
		...
		optionRoute.Use(middleware.RootAuth())
		{
			...
			optionRoute.POST("/sync_group_pricing", controller.SyncGroupPricing)
		}
