...
` + "`max_purchase_total`" + ` integer DEFAULT 0,
` + "`max_purchase_reset_period`" + ` varchar(16) DEFAULT 'never',
` + "`max_purchase_reset_custom_seconds`" + ` bigint DEFAULT 0,
...
PRIMARY KEY (` + "`id`" + `)
	...
	required := []sqliteColumnDef{
		...
		{Name: "max_purchase_total", DDL: "`max_purchase_total` integer DEFAULT 0"},
		{Name: "max_purchase_reset_period", DDL: "`max_purchase_reset_period` varchar(16) DEFAULT 'never'"},
		{Name: "max_purchase_reset_custom_seconds", DDL: "`max_purchase_reset_custom_seconds` bigint DEFAULT 0"},
		{Name: "upgrade_group", DDL: "`upgrade_group` varchar(64) DEFAULT ''"},
		{Name: "total_amount", DDL: "`total_amount` bigint NOT NULL DEFAULT 0"},
		{Name: "quota_reset_period", DDL: "`quota_reset_period` varchar(16) DEFAULT 'never'"},
		{Name: "quota_reset_custom_seconds", DDL: "`quota_reset_custom_seconds` bigint DEFAULT 0"},
		{Name: "quota_tiers", DDL: "`quota_tiers` text"},
