...
const defaultAuthSettings: AuthSettings = {
  ...
  MisskeyOAuthEnabled: false,
  MisskeyInstanceUrl: 'https://dc.hhhl.cc',
  MisskeyInstanceName: 'Universe Federation',
  MisskeyInstanceIcon: 'https://dc.hhhl.cc/client-assets/about-icon.png?v=uf3',
