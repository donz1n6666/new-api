...
var channelAffinityUsageTestSeq uint64

func nextChannelAffinityUsageTestID() uint64 {
	return atomic.AddUint64(&channelAffinityUsageTestSeq, 1)
}
...
func TestObserveChannelAffinityUsageCacheByRelayFormat_ClaudeMode(t *testing.T) {
	seq := nextChannelAffinityUsageTestID()
